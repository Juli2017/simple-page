...
San Mateo County is geographically diverse with coastal areas differing from inland areas. Between 2010 and 2014, San Mateo County added 54,600 new jobs, but only added 2,200 new housing units. As a result, San Mateo County is tied with San Francisco and Marin Counties for having the highest rental costs in the U.S. The rapid growth of the IT sector is having a profound affect on the the daily lives of San Mateo County residents.  The jobs/housing imbalance along with growing income ineqaulity and increasing use of foreign workers in the IT sector can make it feel like a zero-sum game, with a recent poll showing that 40% of Bay Area residents are wanting to leave the area.  
